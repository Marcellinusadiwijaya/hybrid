...
const bihungorDetail = () => {
  const [progress, setProgress] = useState(0);

  const [Resep] = useState([
    {
      bahan: 'Bahan - bahan yang dibutuhkan untuk membuat bihun goreng',
      bahan1: '-Bihun jagung kering',
      bahan2: '-Bawang merah',
      bahan3: '-Bawang putih',
      bahan4: '-Telur',
      ...
      langkah: 'Langkah - langkah yang dibutuhkan untuk membuat bihun goreng',
